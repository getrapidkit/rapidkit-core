#!/usr/bin/env python3
"""Generate a small demo project for Admin Console.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/admin_console-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / f"admin_console-{args.variant}"
