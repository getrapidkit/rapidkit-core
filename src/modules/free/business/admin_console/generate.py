#!/usr/bin/env python3
"""Unified module generator for Admin Console."""
...
from modules.free.business.admin_console.frameworks import get_plugin, list_available_plugins
...
MODULE_NAME = "admin_console"
MODULE_CLASS = "AdminConsole"
MODULE_TITLE = "Admin Console"
MODULE_TIER = "free"
MODULE_SLUG = "free/business/admin_console"
PYTHON_OUTPUT_REL = "src/modules/free/business/admin_console/admin_console.py"
PYTHON_TYPES_REL = "src/modules/free/business/admin_console/admin_console_types.py"
PYTHON_HEALTH_REL = "src/health/business/admin_console.py"
NEST_OUTPUT_REL = "src/modules/free/business/admin_console/admin_console.service.ts"
NEST_CONTROLLER_REL = "src/modules/free/business/admin_console/admin_console.controller.ts"
NEST_MODULE_REL = "src/modules/free/business/admin_console/admin_console.module.ts"
NEST_HEALTH_REL = "src/health/admin_console.health.ts"
NEST_VALIDATION_REL = "src/modules/free/business/admin_console/admin_console.validation.ts"
NEST_INDEX_REL = "src/modules/free/business/admin_console/index.ts"
NEST_CONFIGURATION_REL = "src/modules/free/business/admin_console/configuration.ts"
VENDOR_RELATIVE = "src/modules/free/business/admin_console/admin_console.py"
VENDOR_TYPES_RELATIVE = "src/modules/free/business/admin_console/admin_console_types.py"
VENDOR_HEALTH_RELATIVE = "src/health/business/admin_console.py"
MODULE_IMPORT_PATH = "modules.free.business.admin_console"
...
class AdminConsoleModuleGenerator(BaseModuleGenerator):
...
def _create_generator() -> AdminConsoleModuleGenerator:
    return AdminConsoleModuleGenerator()
