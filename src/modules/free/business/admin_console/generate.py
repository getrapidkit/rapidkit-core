...
PYTHON_OUTPUT_REL = "src/business/admin_console.py"
PYTHON_TYPES_REL = "src/business/admin_console_types.py"
PYTHON_HEALTH_REL = "src/health/business/admin_console.py"
NEST_OUTPUT_REL = "src/admin-console/admin_console.service.ts"
NEST_CONTROLLER_REL = "src/admin-console/admin_console.controller.ts"
NEST_MODULE_REL = "src/admin-console/admin_console.module.ts"
NEST_HEALTH_REL = "src/admin-console/admin_console.health.ts"
NEST_VALIDATION_REL = "src/admin-console/admin_console.validation.ts"
NEST_INDEX_REL = "src/admin-console/index.ts"
NEST_CONFIGURATION_REL = "src/admin-console/configuration.ts"
VENDOR_RELATIVE = "src/business/admin_console.py"
VENDOR_TYPES_RELATIVE = "src/business/admin_console_types.py"
