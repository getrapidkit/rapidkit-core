"""NestJS plugin for Admin Console module scaffolding."""
...
class NestJSPlugin(FrameworkPlugin):
    ...
    def get_template_mappings(self) -> Dict[str, str]:
        return {
            "service": "templates/variants/nestjs/admin_console.service.ts.j2",
            "controller": "templates/variants/nestjs/admin_console.controller.ts.j2",
            "module": "templates/variants/nestjs/admin_console.module.ts.j2",
            "health": "templates/variants/nestjs/admin_console.health.ts.j2",
            "validation": "templates/variants/nestjs/admin_console.validation.ts.j2",
            "index": "templates/variants/nestjs/admin_console.index.ts.j2",
            "configuration": "templates/variants/nestjs/admin_console.configuration.ts.j2",
            "e2e": "templates/variants/nestjs/tests/admin_console.e2e-spec.ts",
        }
