...
PYTHON_OUTPUT_REL = "src/business/document_pipeline.py"
PYTHON_TYPES_REL = "src/business/document_pipeline_types.py"
PYTHON_HEALTH_REL = "src/health/business/document_pipeline.py"
NEST_OUTPUT_REL = "src/document-pipeline/document_pipeline.service.ts"
NEST_CONTROLLER_REL = "src/document-pipeline/document_pipeline.controller.ts"
NEST_MODULE_REL = "src/document-pipeline/document_pipeline.module.ts"
NEST_HEALTH_REL = "src/document-pipeline/document_pipeline.health.ts"
NEST_VALIDATION_REL = "src/document-pipeline/document_pipeline.validation.ts"
NEST_INDEX_REL = "src/document-pipeline/index.ts"
NEST_CONFIGURATION_REL = "src/document-pipeline/configuration.ts"
VENDOR_RELATIVE = "src/business/document_pipeline.py"
VENDOR_TYPES_RELATIVE = "src/business/document_pipeline_types.py"
