#!/usr/bin/env python3
"""Unified module generator for Document Pipeline."""
...
from modules.free.business.document_pipeline.frameworks import get_plugin, list_available_plugins
...
MODULE_CLASS = "DocumentPipeline"
MODULE_TITLE = "Document Pipeline"
MODULE_TIER = "free"
MODULE_SLUG = "free/business/document_pipeline"
PYTHON_OUTPUT_REL = "src/modules/free/business/document_pipeline/document_pipeline.py"
PYTHON_TYPES_REL = "src/modules/free/business/document_pipeline/document_pipeline_types.py"
PYTHON_HEALTH_REL = "src/health/business/document_pipeline.py"
NEST_OUTPUT_REL = "src/modules/free/business/document_pipeline/document_pipeline.service.ts"
NEST_CONTROLLER_REL = "src/modules/free/business/document_pipeline/document_pipeline.controller.ts"
NEST_MODULE_REL = "src/modules/free/business/document_pipeline/document_pipeline.module.ts"
NEST_HEALTH_REL = "src/health/document_pipeline.health.ts"
NEST_VALIDATION_REL = "src/modules/free/business/document_pipeline/document_pipeline.validation.ts"
NEST_INDEX_REL = "src/modules/free/business/document_pipeline/index.ts"
NEST_CONFIGURATION_REL = "src/modules/free/business/document_pipeline/configuration.ts"
VENDOR_RELATIVE = "src/modules/free/business/document_pipeline/document_pipeline.py"
VENDOR_TYPES_RELATIVE = "src/modules/free/business/document_pipeline/document_pipeline_types.py"
VENDOR_HEALTH_RELATIVE = "src/health/business/document_pipeline.py"
MODULE_IMPORT_PATH = "modules.free.business.document_pipeline"
...
class DocumentPipelineModuleGenerator(BaseModuleGenerator):
    ...
    def build_base_context(self, config: Mapping[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "module_kebab": "document-pipeline",
...
def _create_generator() -> DocumentPipelineModuleGenerator:
    return DocumentPipelineModuleGenerator()
