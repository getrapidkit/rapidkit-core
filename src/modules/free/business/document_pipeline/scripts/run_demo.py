#!/usr/bin/env python3
"""Generate a small demo project for Document Pipeline.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/document_pipeline-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / f"document_pipeline-{args.variant}"
