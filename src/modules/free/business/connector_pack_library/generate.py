#!/usr/bin/env python3
"""Unified module generator for Connector Pack Library."""
...
from modules.free.business.connector_pack_library.frameworks import (
    get_plugin,
...
MODULE_CLASS = "ConnectorPackLibrary"
...
class ConnectorPackLibraryModuleGenerator(BaseModuleGenerator):
    ...
    def build_base_context(self, config: Mapping[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "module_kebab": "connector-pack-library",
...
def _create_generator() -> ConnectorPackLibraryModuleGenerator:
    return ConnectorPackLibraryModuleGenerator()
