#!/usr/bin/env python3
"""Generate a small demo project for Connector Pack Library.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/connector_pack_library-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / f"connector_pack_library-{args.variant}"
