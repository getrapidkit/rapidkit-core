# Connector Pack Library Module Documentation

This directory contains the canonical documentation set for the connector pack library module. Keep
guidance concise, actionable, and synchronised with the generator outputs.
