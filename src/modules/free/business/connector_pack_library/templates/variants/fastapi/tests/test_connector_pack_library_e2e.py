"""E2E smoke test for Connector Pack Library (FastAPI).
...
def test_router_builds_without_crashing() -> None:
    ...
    router_rel = "src/modules/free/business/connector_pack_library/routers/business/connector_pack_library.py"
