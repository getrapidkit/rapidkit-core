...
PYTHON_OUTPUT_REL = "src/business/feature_flags.py"
PYTHON_TYPES_REL = "src/business/feature_flags_types.py"
PYTHON_HEALTH_REL = "src/health/business/feature_flags.py"
NEST_OUTPUT_REL = "src/feature-flags/feature_flags.service.ts"
NEST_CONTROLLER_REL = "src/feature-flags/feature_flags.controller.ts"
NEST_MODULE_REL = "src/feature-flags/feature_flags.module.ts"
NEST_HEALTH_REL = "src/feature-flags/feature_flags.health.ts"
NEST_VALIDATION_REL = "src/feature-flags/feature_flags.validation.ts"
NEST_INDEX_REL = "src/feature-flags/index.ts"
NEST_CONFIGURATION_REL = "src/feature-flags/configuration.ts"
VENDOR_RELATIVE = "src/business/feature_flags.py"
VENDOR_TYPES_RELATIVE = "src/business/feature_flags_types.py"
