#!/usr/bin/env python3
"""Generate a small demo project for Feature Flags.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/feature_flags-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / f"feature_flags-{args.variant}"
