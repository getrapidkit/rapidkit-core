...
PYTHON_OUTPUT_REL = "src/business/approval_engine.py"
PYTHON_TYPES_REL = "src/business/approval_engine_types.py"
PYTHON_HEALTH_REL = "src/health/business/approval_engine.py"
NEST_OUTPUT_REL = "src/approval-engine/approval_engine.service.ts"
NEST_CONTROLLER_REL = "src/approval-engine/approval_engine.controller.ts"
NEST_MODULE_REL = "src/approval-engine/approval_engine.module.ts"
NEST_HEALTH_REL = "src/approval-engine/approval_engine.health.ts"
NEST_VALIDATION_REL = "src/approval-engine/approval_engine.validation.ts"
NEST_INDEX_REL = "src/approval-engine/index.ts"
NEST_CONFIGURATION_REL = "src/approval-engine/configuration.ts"
VENDOR_RELATIVE = "src/business/approval_engine.py"
VENDOR_TYPES_RELATIVE = "src/business/approval_engine_types.py"
