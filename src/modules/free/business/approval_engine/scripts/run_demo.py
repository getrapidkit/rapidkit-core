#!/usr/bin/env python3
"""Generate a small demo project for Approval Engine.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/approval_engine-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / f"approval_engine-{args.variant}"
