...
PYTHON_OUTPUT_REL = "src/business/org_admin_console.py"
PYTHON_TYPES_REL = "src/business/org_admin_console_types.py"
PYTHON_HEALTH_REL = "src/health/business/org_admin_console.py"
NEST_OUTPUT_REL = "src/org-admin-console/org_admin_console.service.ts"
NEST_CONTROLLER_REL = "src/org-admin-console/org_admin_console.controller.ts"
NEST_MODULE_REL = "src/org-admin-console/org_admin_console.module.ts"
NEST_HEALTH_REL = "src/org-admin-console/org_admin_console.health.ts"
NEST_VALIDATION_REL = "src/org-admin-console/org_admin_console.validation.ts"
NEST_INDEX_REL = "src/org-admin-console/index.ts"
NEST_CONFIGURATION_REL = "src/org-admin-console/configuration.ts"
VENDOR_RELATIVE = "src/business/org_admin_console.py"
VENDOR_TYPES_RELATIVE = "src/business/org_admin_console_types.py"
