#!/usr/bin/env python3
"""Unified module generator for Org Admin Console."""
...
from modules.free.business.org_admin_console.frameworks import get_plugin, list_available_plugins
...
MODULE_NAME = "org_admin_console"
MODULE_CLASS = "OrgAdminConsole"
MODULE_TITLE = "Org Admin Console"
MODULE_TIER = "free"
MODULE_SLUG = "free/business/org_admin_console"
PYTHON_OUTPUT_REL = "src/modules/free/business/org_admin_console/org_admin_console.py"
PYTHON_TYPES_REL = "src/modules/free/business/org_admin_console/org_admin_console_types.py"
PYTHON_HEALTH_REL = "src/health/business/org_admin_console.py"
NEST_OUTPUT_REL = "src/modules/free/business/org_admin_console/org_admin_console.service.ts"
NEST_CONTROLLER_REL = "src/modules/free/business/org_admin_console/org_admin_console.controller.ts"
NEST_MODULE_REL = "src/modules/free/business/org_admin_console/org_admin_console.module.ts"
NEST_HEALTH_REL = "src/health/org_admin_console.health.ts"
NEST_VALIDATION_REL = "src/modules/free/business/org_admin_console/org_admin_console.validation.ts"
NEST_INDEX_REL = "src/modules/free/business/org_admin_console/index.ts"
NEST_CONFIGURATION_REL = "src/modules/free/business/org_admin_console/configuration.ts"
VENDOR_RELATIVE = "src/modules/free/business/org_admin_console/org_admin_console.py"
VENDOR_TYPES_RELATIVE = "src/modules/free/business/org_admin_console/org_admin_console_types.py"
VENDOR_HEALTH_RELATIVE = "src/health/business/org_admin_console.py"
MODULE_IMPORT_PATH = "modules.free.business.org_admin_console"
...
class OrgAdminConsoleModuleGenerator(BaseModuleGenerator):
    ...
    def build_base_context(self, config: Mapping[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "module_kebab": "org-admin-console",
...
def _create_generator() -> OrgAdminConsoleModuleGenerator:
    return OrgAdminConsoleModuleGenerator()
