#!/usr/bin/env python3
"""Generate a small demo project for Org Admin Console.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/org_admin_console-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / f"org_admin_console-{args.variant}"
