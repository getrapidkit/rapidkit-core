#!/usr/bin/env python3
"""Unified module generator for Multi Tenancy."""
...
from modules.free.business.multi_tenancy.frameworks import get_plugin, list_available_plugins
...
MODULE_NAME = "multi_tenancy"
MODULE_CLASS = "MultiTenancy"
MODULE_TITLE = "Multi Tenancy"
MODULE_TIER = "free"
MODULE_SLUG = "free/business/multi_tenancy"
PYTHON_OUTPUT_REL = "src/modules/free/business/multi_tenancy/multi_tenancy.py"
PYTHON_TYPES_REL = "src/modules/free/business/multi_tenancy/multi_tenancy_types.py"
PYTHON_HEALTH_REL = "src/health/business/multi_tenancy.py"
NEST_OUTPUT_REL = "src/modules/free/business/multi_tenancy/multi_tenancy.service.ts"
NEST_CONTROLLER_REL = "src/modules/free/business/multi_tenancy/multi_tenancy.controller.ts"
NEST_MODULE_REL = "src/modules/free/business/multi_tenancy/multi_tenancy.module.ts"
NEST_HEALTH_REL = "src/health/multi_tenancy.health.ts"
NEST_VALIDATION_REL = "src/modules/free/business/multi_tenancy/multi_tenancy.validation.ts"
NEST_INDEX_REL = "src/modules/free/business/multi_tenancy/index.ts"
NEST_CONFIGURATION_REL = "src/modules/free/business/multi_tenancy/configuration.ts"
VENDOR_RELATIVE = "src/modules/free/business/multi_tenancy/multi_tenancy.py"
VENDOR_TYPES_RELATIVE = "src/modules/free/business/multi_tenancy/multi_tenancy_types.py"
VENDOR_HEALTH_RELATIVE = "src/health/business/multi_tenancy.py"
MODULE_IMPORT_PATH = "modules.free.business.multi_tenancy"
...
class MultiTenancyModuleGenerator(BaseModuleGenerator):
...
def _create_generator() -> MultiTenancyModuleGenerator:
    return MultiTenancyModuleGenerator()
