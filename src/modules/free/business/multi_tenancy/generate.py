...
PYTHON_OUTPUT_REL = "src/business/multi_tenancy.py"
PYTHON_TYPES_REL = "src/business/multi_tenancy_types.py"
PYTHON_HEALTH_REL = "src/health/business/multi_tenancy.py"
NEST_OUTPUT_REL = "src/multi-tenancy/multi_tenancy.service.ts"
NEST_CONTROLLER_REL = "src/multi-tenancy/multi_tenancy.controller.ts"
NEST_MODULE_REL = "src/multi-tenancy/multi_tenancy.module.ts"
NEST_HEALTH_REL = "src/multi-tenancy/multi_tenancy.health.ts"
NEST_VALIDATION_REL = "src/multi-tenancy/multi_tenancy.validation.ts"
NEST_INDEX_REL = "src/multi-tenancy/index.ts"
NEST_CONFIGURATION_REL = "src/multi-tenancy/configuration.ts"
VENDOR_RELATIVE = "src/business/multi_tenancy.py"
VENDOR_TYPES_RELATIVE = "src/business/multi_tenancy_types.py"
