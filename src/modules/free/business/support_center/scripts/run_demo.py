#!/usr/bin/env python3
"""Generate a small demo project for Support Center.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/support_center-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / f"support_center-{args.variant}"
