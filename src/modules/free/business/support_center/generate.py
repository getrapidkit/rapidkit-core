...
PYTHON_OUTPUT_REL = "src/business/support_center.py"
PYTHON_TYPES_REL = "src/business/support_center_types.py"
PYTHON_HEALTH_REL = "src/health/business/support_center.py"
NEST_OUTPUT_REL = "src/support-center/support_center.service.ts"
NEST_CONTROLLER_REL = "src/support-center/support_center.controller.ts"
NEST_MODULE_REL = "src/support-center/support_center.module.ts"
NEST_HEALTH_REL = "src/support-center/support_center.health.ts"
NEST_VALIDATION_REL = "src/support-center/support_center.validation.ts"
NEST_INDEX_REL = "src/support-center/index.ts"
NEST_CONFIGURATION_REL = "src/support-center/configuration.ts"
VENDOR_RELATIVE = "src/business/support_center.py"
VENDOR_TYPES_RELATIVE = "src/business/support_center_types.py"
