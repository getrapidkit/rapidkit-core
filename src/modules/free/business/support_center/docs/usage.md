# Support Center Usage Guide

## Quickstart

```bash
rapidkit modules add support_center --tier free --category business
python -m modules.free.business.support_center.generate fastapi ./tmp/support_center
```
