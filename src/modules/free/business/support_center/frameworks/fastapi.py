"""FastAPI plugin for Support Center module scaffolding."""
...
class FastAPIPlugin(FrameworkPlugin):
    ...
    def get_template_mappings(self) -> Dict[str, str]:
        return {
            "runtime": "templates/variants/fastapi/support_center.py.j2",
            "router": "templates/variants/fastapi/support_center_routes.py.j2",
            "health": "templates/variants/fastapi/support_center_health.py.j2",
            "integration": "templates/tests/integration/test_support_center_integration.j2",
            "e2e": "templates/variants/fastapi/tests/test_support_center_e2e.py",
        }
