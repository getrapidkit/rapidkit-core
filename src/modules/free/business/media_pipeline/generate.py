...
PYTHON_OUTPUT_REL = "src/business/media_pipeline.py"
PYTHON_TYPES_REL = "src/business/media_pipeline_types.py"
PYTHON_HEALTH_REL = "src/health/business/media_pipeline.py"
NEST_OUTPUT_REL = "src/media-pipeline/media_pipeline.service.ts"
NEST_CONTROLLER_REL = "src/media-pipeline/media_pipeline.controller.ts"
NEST_MODULE_REL = "src/media-pipeline/media_pipeline.module.ts"
NEST_HEALTH_REL = "src/media-pipeline/media_pipeline.health.ts"
NEST_VALIDATION_REL = "src/media-pipeline/media_pipeline.validation.ts"
NEST_INDEX_REL = "src/media-pipeline/index.ts"
NEST_CONFIGURATION_REL = "src/media-pipeline/configuration.ts"
VENDOR_RELATIVE = "src/business/media_pipeline.py"
VENDOR_TYPES_RELATIVE = "src/business/media_pipeline_types.py"
