#!/usr/bin/env python3
"""Unified module generator for Media Pipeline."""
...
from modules.free.business.media_pipeline.frameworks import get_plugin, list_available_plugins
...
MODULE_NAME = "media_pipeline"
MODULE_CLASS = "MediaPipeline"
MODULE_TITLE = "Media Pipeline"
MODULE_TIER = "free"
MODULE_SLUG = "free/business/media_pipeline"
PYTHON_OUTPUT_REL = "src/modules/free/business/media_pipeline/media_pipeline.py"
PYTHON_TYPES_REL = "src/modules/free/business/media_pipeline/media_pipeline_types.py"
PYTHON_HEALTH_REL = "src/health/business/media_pipeline.py"
NEST_OUTPUT_REL = "src/modules/free/business/media_pipeline/media_pipeline.service.ts"
NEST_CONTROLLER_REL = "src/modules/free/business/media_pipeline/media_pipeline.controller.ts"
NEST_MODULE_REL = "src/modules/free/business/media_pipeline/media_pipeline.module.ts"
NEST_HEALTH_REL = "src/health/media_pipeline.health.ts"
NEST_VALIDATION_REL = "src/modules/free/business/media_pipeline/media_pipeline.validation.ts"
NEST_INDEX_REL = "src/modules/free/business/media_pipeline/index.ts"
NEST_CONFIGURATION_REL = "src/modules/free/business/media_pipeline/configuration.ts"
VENDOR_RELATIVE = "src/modules/free/business/media_pipeline/media_pipeline.py"
VENDOR_TYPES_RELATIVE = "src/modules/free/business/media_pipeline/media_pipeline_types.py"
VENDOR_HEALTH_RELATIVE = "src/health/business/media_pipeline.py"
MODULE_IMPORT_PATH = "modules.free.business.media_pipeline"
...
class MediaPipelineModuleGenerator(BaseModuleGenerator):
...
def _create_generator() -> MediaPipelineModuleGenerator:
    return MediaPipelineModuleGenerator()
