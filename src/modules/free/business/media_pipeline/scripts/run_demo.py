#!/usr/bin/env python3
"""Generate a small demo project for Media Pipeline.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/media_pipeline-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / f"media_pipeline-{args.variant}"
