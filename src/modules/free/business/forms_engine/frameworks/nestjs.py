"""NestJS plugin for Forms Engine module scaffolding."""
...
class NestJSPlugin(FrameworkPlugin):
    ...
    def get_template_mappings(self) -> Dict[str, str]:
        return {
            "service": "templates/variants/nestjs/forms_engine.service.ts.j2",
            "controller": "templates/variants/nestjs/forms_engine.controller.ts.j2",
            "module": "templates/variants/nestjs/forms_engine.module.ts.j2",
            "health": "templates/variants/nestjs/forms_engine.health.ts.j2",
            "validation": "templates/variants/nestjs/forms_engine.validation.ts.j2",
            "index": "templates/variants/nestjs/forms_engine.index.ts.j2",
            "configuration": "templates/variants/nestjs/forms_engine.configuration.ts.j2",
            "e2e": "templates/variants/nestjs/tests/forms_engine.e2e-spec.ts",
        }
