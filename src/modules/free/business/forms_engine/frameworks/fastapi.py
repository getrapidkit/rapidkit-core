"""FastAPI plugin for Forms Engine module scaffolding."""
...
class FastAPIPlugin(FrameworkPlugin):
    ...
    def get_template_mappings(self) -> Dict[str, str]:
        return {
            "runtime": "templates/variants/fastapi/forms_engine.py.j2",
            "router": "templates/variants/fastapi/forms_engine_routes.py.j2",
            "health": "templates/variants/fastapi/forms_engine_health.py.j2",
            "integration": "templates/tests/integration/test_forms_engine_integration.j2",
            "e2e": "templates/variants/fastapi/tests/test_forms_engine_e2e.py",
        }
