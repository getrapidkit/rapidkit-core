#!/usr/bin/env python3
"""Unified module generator for Forms Engine."""
...
from modules.free.business.forms_engine.frameworks import get_plugin, list_available_plugins
...
MODULE_NAME = "forms_engine"
MODULE_CLASS = "FormsEngine"
MODULE_TITLE = "Forms Engine"
MODULE_TIER = "free"
MODULE_SLUG = "free/business/forms_engine"
PYTHON_OUTPUT_REL = "src/modules/free/business/forms_engine/forms_engine.py"
PYTHON_TYPES_REL = "src/modules/free/business/forms_engine/forms_engine_types.py"
PYTHON_HEALTH_REL = "src/health/business/forms_engine.py"
NEST_OUTPUT_REL = "src/modules/free/business/forms_engine/forms_engine.service.ts"
NEST_CONTROLLER_REL = "src/modules/free/business/forms_engine/forms_engine.controller.ts"
NEST_MODULE_REL = "src/modules/free/business/forms_engine/forms_engine.module.ts"
NEST_HEALTH_REL = "src/health/forms_engine.health.ts"
NEST_VALIDATION_REL = "src/modules/free/business/forms_engine/forms_engine.validation.ts"
NEST_INDEX_REL = "src/modules/free/business/forms_engine/index.ts"
NEST_CONFIGURATION_REL = "src/modules/free/business/forms_engine/configuration.ts"
VENDOR_RELATIVE = "src/modules/free/business/forms_engine/forms_engine.py"
VENDOR_TYPES_RELATIVE = "src/modules/free/business/forms_engine/forms_engine_types.py"
VENDOR_HEALTH_RELATIVE = "src/health/business/forms_engine.py"
MODULE_IMPORT_PATH = "modules.free.business.forms_engine"
...
class FormsEngineModuleGenerator(BaseModuleGenerator):
...
def _create_generator() -> FormsEngineModuleGenerator:
    return FormsEngineModuleGenerator()
