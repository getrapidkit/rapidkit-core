...
PYTHON_OUTPUT_REL = "src/business/forms_engine.py"
PYTHON_TYPES_REL = "src/business/forms_engine_types.py"
PYTHON_HEALTH_REL = "src/health/business/forms_engine.py"
NEST_OUTPUT_REL = "src/forms-engine/forms_engine.service.ts"
NEST_CONTROLLER_REL = "src/forms-engine/forms_engine.controller.ts"
NEST_MODULE_REL = "src/forms-engine/forms_engine.module.ts"
NEST_HEALTH_REL = "src/forms-engine/forms_engine.health.ts"
NEST_VALIDATION_REL = "src/forms-engine/forms_engine.validation.ts"
NEST_INDEX_REL = "src/forms-engine/index.ts"
NEST_CONFIGURATION_REL = "src/forms-engine/configuration.ts"
VENDOR_RELATIVE = "src/business/forms_engine.py"
VENDOR_TYPES_RELATIVE = "src/business/forms_engine_types.py"
