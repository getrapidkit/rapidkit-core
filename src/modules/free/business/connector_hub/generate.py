#!/usr/bin/env python3
"""Unified module generator for Connector Hub."""
...
from modules.free.business.connector_hub.frameworks import get_plugin, list_available_plugins
...
MODULE_NAME = "connector_hub"
MODULE_CLASS = "ConnectorHub"
MODULE_TITLE = "Connector Hub"
MODULE_TIER = "free"
MODULE_SLUG = "free/business/connector_hub"
PYTHON_OUTPUT_REL = "src/modules/free/business/connector_hub/connector_hub.py"
PYTHON_TYPES_REL = "src/modules/free/business/connector_hub/connector_hub_types.py"
PYTHON_HEALTH_REL = "src/health/business/connector_hub.py"
NEST_OUTPUT_REL = "src/modules/free/business/connector_hub/connector_hub.service.ts"
NEST_CONTROLLER_REL = "src/modules/free/business/connector_hub/connector_hub.controller.ts"
NEST_MODULE_REL = "src/modules/free/business/connector_hub/connector_hub.module.ts"
NEST_HEALTH_REL = "src/health/connector_hub.health.ts"
NEST_VALIDATION_REL = "src/modules/free/business/connector_hub/connector_hub.validation.ts"
NEST_INDEX_REL = "src/modules/free/business/connector_hub/index.ts"
NEST_CONFIGURATION_REL = "src/modules/free/business/connector_hub/configuration.ts"
VENDOR_RELATIVE = "src/modules/free/business/connector_hub/connector_hub.py"
VENDOR_TYPES_RELATIVE = "src/modules/free/business/connector_hub/connector_hub_types.py"
VENDOR_HEALTH_RELATIVE = "src/health/business/connector_hub.py"
MODULE_IMPORT_PATH = "modules.free.business.connector_hub"
...
class ConnectorHubModuleGenerator(BaseModuleGenerator):
...
def _create_generator() -> ConnectorHubModuleGenerator:
    return ConnectorHubModuleGenerator()
