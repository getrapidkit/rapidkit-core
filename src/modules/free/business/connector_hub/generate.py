...
PYTHON_OUTPUT_REL = "src/business/connector_hub.py"
PYTHON_TYPES_REL = "src/business/connector_hub_types.py"
PYTHON_HEALTH_REL = "src/health/business/connector_hub.py"
NEST_OUTPUT_REL = "src/connector-hub/connector_hub.service.ts"
NEST_CONTROLLER_REL = "src/connector-hub/connector_hub.controller.ts"
NEST_MODULE_REL = "src/connector-hub/connector_hub.module.ts"
NEST_HEALTH_REL = "src/connector-hub/connector_hub.health.ts"
NEST_VALIDATION_REL = "src/connector-hub/connector_hub.validation.ts"
NEST_INDEX_REL = "src/connector-hub/index.ts"
NEST_CONFIGURATION_REL = "src/connector-hub/configuration.ts"
VENDOR_RELATIVE = "src/business/connector_hub.py"
VENDOR_TYPES_RELATIVE = "src/business/connector_hub_types.py"
