"""NestJS plugin for Connector Hub module scaffolding."""
...
class NestJSPlugin(FrameworkPlugin):
    ...
    def get_template_mappings(self) -> Dict[str, str]:
        return {
            "service": "templates/variants/nestjs/connector_hub.service.ts.j2",
            "controller": "templates/variants/nestjs/connector_hub.controller.ts.j2",
            "module": "templates/variants/nestjs/connector_hub.module.ts.j2",
            "health": "templates/variants/nestjs/connector_hub.health.ts.j2",
            "validation": "templates/variants/nestjs/connector_hub.validation.ts.j2",
            "index": "templates/variants/nestjs/connector_hub.index.ts.j2",
            "configuration": "templates/variants/nestjs/connector_hub.configuration.ts.j2",
            "e2e": "templates/variants/nestjs/tests/connector_hub.e2e-spec.ts",
        }
