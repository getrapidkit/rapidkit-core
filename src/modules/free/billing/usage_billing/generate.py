#!/usr/bin/env python3
"""Unified module generator for Usage Billing."""
...
from modules.free.billing.usage_billing.frameworks import get_plugin, list_available_plugins
...
MODULE_NAME = "usage_billing"
MODULE_CLASS = "UsageBilling"
MODULE_TITLE = "Usage Billing"
MODULE_TIER = "free"
MODULE_SLUG = "free/billing/usage_billing"
PYTHON_OUTPUT_REL = "src/modules/free/billing/usage_billing/usage_billing.py"
PYTHON_TYPES_REL = "src/modules/free/billing/usage_billing/usage_billing_types.py"
PYTHON_HEALTH_REL = "src/health/billing/usage_billing.py"
NEST_OUTPUT_REL = "src/modules/free/billing/usage_billing/usage_billing.service.ts"
NEST_CONTROLLER_REL = "src/modules/free/billing/usage_billing/usage_billing.controller.ts"
NEST_MODULE_REL = "src/modules/free/billing/usage_billing/usage_billing.module.ts"
NEST_HEALTH_REL = "src/health/usage_billing.health.ts"
NEST_VALIDATION_REL = "src/modules/free/billing/usage_billing/usage_billing.validation.ts"
NEST_INDEX_REL = "src/modules/free/billing/usage_billing/index.ts"
NEST_CONFIGURATION_REL = "src/modules/free/billing/usage_billing/configuration.ts"
VENDOR_RELATIVE = "src/modules/free/billing/usage_billing/usage_billing.py"
VENDOR_TYPES_RELATIVE = "src/modules/free/billing/usage_billing/usage_billing_types.py"
VENDOR_HEALTH_RELATIVE = "src/health/billing/usage_billing.py"
MODULE_IMPORT_PATH = "modules.free.billing.usage_billing"
...
class UsageBillingModuleGenerator(BaseModuleGenerator):
...
def _create_generator() -> UsageBillingModuleGenerator:
    return UsageBillingModuleGenerator()
