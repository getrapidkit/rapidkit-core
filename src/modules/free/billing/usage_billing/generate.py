...
PYTHON_OUTPUT_REL = "src/billing/usage_billing.py"
PYTHON_TYPES_REL = "src/billing/usage_billing_types.py"
PYTHON_HEALTH_REL = "src/health/billing/usage_billing.py"
NEST_OUTPUT_REL = "src/usage-billing/usage_billing.service.ts"
NEST_CONTROLLER_REL = "src/usage-billing/usage_billing.controller.ts"
NEST_MODULE_REL = "src/usage-billing/usage_billing.module.ts"
NEST_HEALTH_REL = "src/usage-billing/usage_billing.health.ts"
NEST_VALIDATION_REL = "src/usage-billing/usage_billing.validation.ts"
NEST_INDEX_REL = "src/usage-billing/index.ts"
NEST_CONFIGURATION_REL = "src/usage-billing/configuration.ts"
VENDOR_RELATIVE = "src/billing/usage_billing.py"
VENDOR_TYPES_RELATIVE = "src/billing/usage_billing_types.py"
