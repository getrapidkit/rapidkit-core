...
PYTHON_OUTPUT_REL = "src/ai/agent_runtime.py"
PYTHON_TYPES_REL = "src/ai/agent_runtime_types.py"
PYTHON_HEALTH_REL = "src/health/ai/agent_runtime.py"
NEST_OUTPUT_REL = "src/agent-runtime/agent_runtime.service.ts"
NEST_CONTROLLER_REL = "src/agent-runtime/agent_runtime.controller.ts"
NEST_MODULE_REL = "src/agent-runtime/agent_runtime.module.ts"
NEST_HEALTH_REL = "src/agent-runtime/agent_runtime.health.ts"
NEST_VALIDATION_REL = "src/agent-runtime/agent_runtime.validation.ts"
NEST_INDEX_REL = "src/agent-runtime/index.ts"
NEST_CONFIGURATION_REL = "src/agent-runtime/configuration.ts"
VENDOR_RELATIVE = "src/ai/agent_runtime.py"
VENDOR_TYPES_RELATIVE = "src/ai/agent_runtime_types.py"
