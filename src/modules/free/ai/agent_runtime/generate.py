#!/usr/bin/env python3
"""Unified module generator for Agent Runtime."""
...
from modules.free.ai.agent_runtime.frameworks import get_plugin, list_available_plugins
...
MODULE_CLASS = "AgentRuntime"
MODULE_TITLE = "Agent Runtime"
MODULE_TIER = "free"
MODULE_SLUG = "free/ai/agent_runtime"
PYTHON_OUTPUT_REL = "src/modules/free/ai/agent_runtime/agent_runtime.py"
PYTHON_TYPES_REL = "src/modules/free/ai/agent_runtime/agent_runtime_types.py"
PYTHON_HEALTH_REL = "src/health/ai/agent_runtime.py"
NEST_OUTPUT_REL = "src/modules/free/ai/agent_runtime/agent_runtime.service.ts"
NEST_CONTROLLER_REL = "src/modules/free/ai/agent_runtime/agent_runtime.controller.ts"
NEST_MODULE_REL = "src/modules/free/ai/agent_runtime/agent_runtime.module.ts"
NEST_HEALTH_REL = "src/health/agent_runtime.health.ts"
NEST_VALIDATION_REL = "src/modules/free/ai/agent_runtime/agent_runtime.validation.ts"
NEST_INDEX_REL = "src/modules/free/ai/agent_runtime/index.ts"
NEST_CONFIGURATION_REL = "src/modules/free/ai/agent_runtime/configuration.ts"
VENDOR_RELATIVE = "src/modules/free/ai/agent_runtime/agent_runtime.py"
VENDOR_TYPES_RELATIVE = "src/modules/free/ai/agent_runtime/agent_runtime_types.py"
VENDOR_HEALTH_RELATIVE = "src/health/ai/agent_runtime.py"
MODULE_IMPORT_PATH = "modules.free.ai.agent_runtime"
...
class AgentRuntimeModuleGenerator(BaseModuleGenerator):
...
def _create_generator() -> AgentRuntimeModuleGenerator:
    return AgentRuntimeModuleGenerator()
