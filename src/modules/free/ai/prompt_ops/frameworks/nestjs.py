"""NestJS plugin for Prompt Ops module scaffolding."""
...
class NestJSPlugin(FrameworkPlugin):
    ...
    def get_template_mappings(self) -> Dict[str, str]:
        return {
            "service": "templates/variants/nestjs/prompt_ops.service.ts.j2",
            "controller": "templates/variants/nestjs/prompt_ops.controller.ts.j2",
            "module": "templates/variants/nestjs/prompt_ops.module.ts.j2",
            "health": "templates/variants/nestjs/prompt_ops.health.ts.j2",
            "validation": "templates/variants/nestjs/prompt_ops.validation.ts.j2",
            "index": "templates/variants/nestjs/prompt_ops.index.ts.j2",
            "configuration": "templates/variants/nestjs/prompt_ops.configuration.ts.j2",
            "e2e": "templates/variants/nestjs/tests/prompt_ops.e2e-spec.ts",
        }
