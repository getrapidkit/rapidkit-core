#!/usr/bin/env python3
"""Generate a small demo project for Prompt Ops.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/prompt_ops-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / f"prompt_ops-{args.variant}"
