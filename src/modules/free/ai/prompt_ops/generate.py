...
PYTHON_OUTPUT_REL = "src/ai/prompt_ops.py"
PYTHON_TYPES_REL = "src/ai/prompt_ops_types.py"
PYTHON_HEALTH_REL = "src/health/ai/prompt_ops.py"
NEST_OUTPUT_REL = "src/prompt-ops/prompt_ops.service.ts"
NEST_CONTROLLER_REL = "src/prompt-ops/prompt_ops.controller.ts"
NEST_MODULE_REL = "src/prompt-ops/prompt_ops.module.ts"
NEST_HEALTH_REL = "src/prompt-ops/prompt_ops.health.ts"
NEST_VALIDATION_REL = "src/prompt-ops/prompt_ops.validation.ts"
NEST_INDEX_REL = "src/prompt-ops/index.ts"
NEST_CONFIGURATION_REL = "src/prompt-ops/configuration.ts"
VENDOR_RELATIVE = "src/ai/prompt_ops.py"
VENDOR_TYPES_RELATIVE = "src/ai/prompt_ops_types.py"
