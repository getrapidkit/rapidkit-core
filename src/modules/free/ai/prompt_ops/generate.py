#!/usr/bin/env python3
"""Unified module generator for Prompt Ops."""
...
from modules.free.ai.prompt_ops.frameworks import get_plugin, list_available_plugins
...
MODULE_NAME = "prompt_ops"
MODULE_CLASS = "PromptOps"
MODULE_TITLE = "Prompt Ops"
MODULE_TIER = "free"
MODULE_SLUG = "free/ai/prompt_ops"
PYTHON_OUTPUT_REL = "src/modules/free/ai/prompt_ops/prompt_ops.py"
PYTHON_TYPES_REL = "src/modules/free/ai/prompt_ops/prompt_ops_types.py"
PYTHON_HEALTH_REL = "src/health/ai/prompt_ops.py"
NEST_OUTPUT_REL = "src/modules/free/ai/prompt_ops/prompt_ops.service.ts"
NEST_CONTROLLER_REL = "src/modules/free/ai/prompt_ops/prompt_ops.controller.ts"
NEST_MODULE_REL = "src/modules/free/ai/prompt_ops/prompt_ops.module.ts"
NEST_HEALTH_REL = "src/health/prompt_ops.health.ts"
NEST_VALIDATION_REL = "src/modules/free/ai/prompt_ops/prompt_ops.validation.ts"
NEST_INDEX_REL = "src/modules/free/ai/prompt_ops/index.ts"
NEST_CONFIGURATION_REL = "src/modules/free/ai/prompt_ops/configuration.ts"
VENDOR_RELATIVE = "src/modules/free/ai/prompt_ops/prompt_ops.py"
VENDOR_TYPES_RELATIVE = "src/modules/free/ai/prompt_ops/prompt_ops_types.py"
VENDOR_HEALTH_RELATIVE = "src/health/ai/prompt_ops.py"
MODULE_IMPORT_PATH = "modules.free.ai.prompt_ops"
...
class PromptOpsModuleGenerator(BaseModuleGenerator):
...
def _create_generator() -> PromptOpsModuleGenerator:
    return PromptOpsModuleGenerator()
