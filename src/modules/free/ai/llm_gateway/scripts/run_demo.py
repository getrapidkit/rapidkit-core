#!/usr/bin/env python3
"""Generate a small demo project for Llm Gateway.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/llm_gateway-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / f"llm_gateway-{args.variant}"
