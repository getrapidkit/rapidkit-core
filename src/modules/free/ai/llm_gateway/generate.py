#!/usr/bin/env python3
"""Unified module generator for Llm Gateway."""
...
from modules.free.ai.llm_gateway.frameworks import get_plugin, list_available_plugins
...
MODULE_CLASS = "LlmGateway"
MODULE_TITLE = "Llm Gateway"
MODULE_TIER = "free"
MODULE_SLUG = "free/ai/llm_gateway"
PYTHON_OUTPUT_REL = "src/modules/free/ai/llm_gateway/llm_gateway.py"
PYTHON_TYPES_REL = "src/modules/free/ai/llm_gateway/llm_gateway_types.py"
PYTHON_HEALTH_REL = "src/health/ai/llm_gateway.py"
NEST_OUTPUT_REL = "src/modules/free/ai/llm_gateway/llm_gateway.service.ts"
NEST_CONTROLLER_REL = "src/modules/free/ai/llm_gateway/llm_gateway.controller.ts"
NEST_MODULE_REL = "src/modules/free/ai/llm_gateway/llm_gateway.module.ts"
NEST_HEALTH_REL = "src/health/llm_gateway.health.ts"
NEST_VALIDATION_REL = "src/modules/free/ai/llm_gateway/llm_gateway.validation.ts"
NEST_INDEX_REL = "src/modules/free/ai/llm_gateway/index.ts"
NEST_CONFIGURATION_REL = "src/modules/free/ai/llm_gateway/configuration.ts"
VENDOR_RELATIVE = "src/modules/free/ai/llm_gateway/llm_gateway.py"
VENDOR_TYPES_RELATIVE = "src/modules/free/ai/llm_gateway/llm_gateway_types.py"
VENDOR_HEALTH_RELATIVE = "src/health/ai/llm_gateway.py"
MODULE_IMPORT_PATH = "modules.free.ai.llm_gateway"
...
class LlmGatewayModuleGenerator(BaseModuleGenerator):
...
def _create_generator() -> LlmGatewayModuleGenerator:
    return LlmGatewayModuleGenerator()
