...
PYTHON_OUTPUT_REL = "src/ai/llm_gateway.py"
PYTHON_TYPES_REL = "src/ai/llm_gateway_types.py"
PYTHON_HEALTH_REL = "src/health/ai/llm_gateway.py"
NEST_OUTPUT_REL = "src/llm-gateway/llm_gateway.service.ts"
NEST_CONTROLLER_REL = "src/llm-gateway/llm_gateway.controller.ts"
NEST_MODULE_REL = "src/llm-gateway/llm_gateway.module.ts"
NEST_HEALTH_REL = "src/llm-gateway/llm_gateway.health.ts"
NEST_VALIDATION_REL = "src/llm-gateway/llm_gateway.validation.ts"
NEST_INDEX_REL = "src/llm-gateway/index.ts"
NEST_CONFIGURATION_REL = "src/llm-gateway/configuration.ts"
VENDOR_RELATIVE = "src/ai/llm_gateway.py"
VENDOR_TYPES_RELATIVE = "src/ai/llm_gateway_types.py"
