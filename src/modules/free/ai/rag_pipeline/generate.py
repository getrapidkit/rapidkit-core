#!/usr/bin/env python3
"""Unified module generator for Rag Pipeline."""
...
from modules.free.ai.rag_pipeline.frameworks import get_plugin, list_available_plugins
...
MODULE_CLASS = "RagPipeline"
MODULE_TITLE = "Rag Pipeline"
MODULE_TIER = "free"
MODULE_SLUG = "free/ai/rag_pipeline"
PYTHON_OUTPUT_REL = "src/modules/free/ai/rag_pipeline/rag_pipeline.py"
PYTHON_TYPES_REL = "src/modules/free/ai/rag_pipeline/rag_pipeline_types.py"
PYTHON_HEALTH_REL = "src/health/ai/rag_pipeline.py"
NEST_OUTPUT_REL = "src/modules/free/ai/rag_pipeline/rag_pipeline.service.ts"
NEST_CONTROLLER_REL = "src/modules/free/ai/rag_pipeline/rag_pipeline.controller.ts"
NEST_MODULE_REL = "src/modules/free/ai/rag_pipeline/rag_pipeline.module.ts"
NEST_HEALTH_REL = "src/health/rag_pipeline.health.ts"
NEST_VALIDATION_REL = "src/modules/free/ai/rag_pipeline/rag_pipeline.validation.ts"
NEST_INDEX_REL = "src/modules/free/ai/rag_pipeline/index.ts"
NEST_CONFIGURATION_REL = "src/modules/free/ai/rag_pipeline/configuration.ts"
VENDOR_RELATIVE = "src/modules/free/ai/rag_pipeline/rag_pipeline.py"
VENDOR_TYPES_RELATIVE = "src/modules/free/ai/rag_pipeline/rag_pipeline_types.py"
VENDOR_HEALTH_RELATIVE = "src/health/ai/rag_pipeline.py"
MODULE_IMPORT_PATH = "modules.free.ai.rag_pipeline"
...
class RagPipelineModuleGenerator(BaseModuleGenerator):
...
def _create_generator() -> RagPipelineModuleGenerator:
    return RagPipelineModuleGenerator()
