...
PYTHON_OUTPUT_REL = "src/ai/rag_pipeline.py"
PYTHON_TYPES_REL = "src/ai/rag_pipeline_types.py"
PYTHON_HEALTH_REL = "src/health/ai/rag_pipeline.py"
NEST_OUTPUT_REL = "src/rag-pipeline/rag_pipeline.service.ts"
NEST_CONTROLLER_REL = "src/rag-pipeline/rag_pipeline.controller.ts"
NEST_MODULE_REL = "src/rag-pipeline/rag_pipeline.module.ts"
NEST_HEALTH_REL = "src/rag-pipeline/rag_pipeline.health.ts"
NEST_VALIDATION_REL = "src/rag-pipeline/rag_pipeline.validation.ts"
NEST_INDEX_REL = "src/rag-pipeline/index.ts"
NEST_CONFIGURATION_REL = "src/rag-pipeline/configuration.ts"
VENDOR_RELATIVE = "src/ai/rag_pipeline.py"
VENDOR_TYPES_RELATIVE = "src/ai/rag_pipeline_types.py"
