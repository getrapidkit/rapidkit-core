#!/usr/bin/env python3
"""Generate a small demo project for Rag Pipeline.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/rag_pipeline-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / f"rag_pipeline-{args.variant}"
