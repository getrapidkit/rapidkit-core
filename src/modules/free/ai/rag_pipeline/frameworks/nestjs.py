"""NestJS plugin for Rag Pipeline module scaffolding."""
...
class NestJSPlugin(FrameworkPlugin):
    ...
    def get_template_mappings(self) -> Dict[str, str]:
        return {
            "service": "templates/variants/nestjs/rag_pipeline.service.ts.j2",
            "controller": "templates/variants/nestjs/rag_pipeline.controller.ts.j2",
            "module": "templates/variants/nestjs/rag_pipeline.module.ts.j2",
            "health": "templates/variants/nestjs/rag_pipeline.health.ts.j2",
            "validation": "templates/variants/nestjs/rag_pipeline.validation.ts.j2",
            "index": "templates/variants/nestjs/rag_pipeline.index.ts.j2",
            "configuration": "templates/variants/nestjs/rag_pipeline.configuration.ts.j2",
            "e2e": "templates/variants/nestjs/tests/rag_pipeline.e2e-spec.ts",
        }
