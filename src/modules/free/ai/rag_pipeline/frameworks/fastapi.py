"""FastAPI plugin for Rag Pipeline module scaffolding."""
...
class FastAPIPlugin(FrameworkPlugin):
    ...
    def get_template_mappings(self) -> Dict[str, str]:
        return {
            "runtime": "templates/variants/fastapi/rag_pipeline.py.j2",
            "router": "templates/variants/fastapi/rag_pipeline_routes.py.j2",
            "health": "templates/variants/fastapi/rag_pipeline_health.py.j2",
            "integration": "templates/tests/integration/test_rag_pipeline_integration.j2",
            "e2e": "templates/variants/fastapi/tests/test_rag_pipeline_e2e.py",
        }

    def get_output_paths(self) -> Dict[str, str]:
        return {
            "runtime": "src/modules/free/ai/rag_pipeline/rag_pipeline.py",
            "router": "src/modules/free/ai/rag_pipeline/routers/ai/rag_pipeline.py",
            "health": "src/health/ai/rag_pipeline.py",
            "integration": "tests/modules/free/integration/ai/rag_pipeline/test_rag_pipeline_integration.py",
            "e2e": "tests/modules/e2e/free/ai/rag_pipeline/test_rag_pipeline_e2e.py",
        }
