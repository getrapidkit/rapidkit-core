"""FastAPI plugin for Vector Store module scaffolding."""
...
class FastAPIPlugin(FrameworkPlugin):
    ...
    def get_template_mappings(self) -> Dict[str, str]:
        return {
            "runtime": "templates/variants/fastapi/vector_store.py.j2",
            "router": "templates/variants/fastapi/vector_store_routes.py.j2",
            "health": "templates/variants/fastapi/vector_store_health.py.j2",
            "integration": "templates/tests/integration/test_vector_store_integration.j2",
            "e2e": "templates/variants/fastapi/tests/test_vector_store_e2e.py",
        }
