#!/usr/bin/env python3
"""Generate a small demo project for Vector Store.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/vector_store-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / f"vector_store-{args.variant}"
