...
PYTHON_OUTPUT_REL = "src/ai/vector_store.py"
PYTHON_TYPES_REL = "src/ai/vector_store_types.py"
PYTHON_HEALTH_REL = "src/health/ai/vector_store.py"
NEST_OUTPUT_REL = "src/vector-store/vector_store.service.ts"
NEST_CONTROLLER_REL = "src/vector-store/vector_store.controller.ts"
NEST_MODULE_REL = "src/vector-store/vector_store.module.ts"
NEST_HEALTH_REL = "src/vector-store/vector_store.health.ts"
NEST_VALIDATION_REL = "src/vector-store/vector_store.validation.ts"
NEST_INDEX_REL = "src/vector-store/index.ts"
NEST_CONFIGURATION_REL = "src/vector-store/configuration.ts"
VENDOR_RELATIVE = "src/ai/vector_store.py"
VENDOR_TYPES_RELATIVE = "src/ai/vector_store_types.py"
