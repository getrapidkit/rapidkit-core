#!/usr/bin/env python3
"""Unified module generator for Tool Registry."""
...
from modules.free.ai.tool_registry.frameworks import get_plugin, list_available_plugins
...
MODULE_CLASS = "ToolRegistry"
MODULE_TITLE = "Tool Registry"
MODULE_TIER = "free"
MODULE_SLUG = "free/ai/tool_registry"
PYTHON_OUTPUT_REL = "src/modules/free/ai/tool_registry/tool_registry.py"
PYTHON_TYPES_REL = "src/modules/free/ai/tool_registry/tool_registry_types.py"
PYTHON_HEALTH_REL = "src/health/ai/tool_registry.py"
NEST_OUTPUT_REL = "src/modules/free/ai/tool_registry/tool_registry.service.ts"
NEST_CONTROLLER_REL = "src/modules/free/ai/tool_registry/tool_registry.controller.ts"
NEST_MODULE_REL = "src/modules/free/ai/tool_registry/tool_registry.module.ts"
NEST_HEALTH_REL = "src/health/tool_registry.health.ts"
NEST_VALIDATION_REL = "src/modules/free/ai/tool_registry/tool_registry.validation.ts"
NEST_INDEX_REL = "src/modules/free/ai/tool_registry/index.ts"
NEST_CONFIGURATION_REL = "src/modules/free/ai/tool_registry/configuration.ts"
VENDOR_RELATIVE = "src/modules/free/ai/tool_registry/tool_registry.py"
VENDOR_TYPES_RELATIVE = "src/modules/free/ai/tool_registry/tool_registry_types.py"
VENDOR_HEALTH_RELATIVE = "src/health/ai/tool_registry.py"
MODULE_IMPORT_PATH = "modules.free.ai.tool_registry"
...
class ToolRegistryModuleGenerator(BaseModuleGenerator):
...
def _create_generator() -> ToolRegistryModuleGenerator:
    return ToolRegistryModuleGenerator()
