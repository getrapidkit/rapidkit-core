...
PYTHON_OUTPUT_REL = "src/ai/tool_registry.py"
PYTHON_TYPES_REL = "src/ai/tool_registry_types.py"
PYTHON_HEALTH_REL = "src/health/ai/tool_registry.py"
NEST_OUTPUT_REL = "src/tool-registry/tool_registry.service.ts"
NEST_CONTROLLER_REL = "src/tool-registry/tool_registry.controller.ts"
NEST_MODULE_REL = "src/tool-registry/tool_registry.module.ts"
NEST_HEALTH_REL = "src/tool-registry/tool_registry.health.ts"
NEST_VALIDATION_REL = "src/tool-registry/tool_registry.validation.ts"
NEST_INDEX_REL = "src/tool-registry/index.ts"
NEST_CONFIGURATION_REL = "src/tool-registry/configuration.ts"
VENDOR_RELATIVE = "src/ai/tool_registry.py"
VENDOR_TYPES_RELATIVE = "src/ai/tool_registry_types.py"
