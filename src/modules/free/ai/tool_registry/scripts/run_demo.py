#!/usr/bin/env python3
"""Generate a small demo project for Tool Registry.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/tool_registry-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / f"tool_registry-{args.variant}"
