...
PYTHON_OUTPUT_REL = "src/ai/ai_guardrails.py"
PYTHON_TYPES_REL = "src/ai/ai_guardrails_types.py"
PYTHON_HEALTH_REL = "src/health/ai/ai_guardrails.py"
NEST_OUTPUT_REL = "src/ai-guardrails/ai_guardrails.service.ts"
NEST_CONTROLLER_REL = "src/ai-guardrails/ai_guardrails.controller.ts"
NEST_MODULE_REL = "src/ai-guardrails/ai_guardrails.module.ts"
NEST_HEALTH_REL = "src/ai-guardrails/ai_guardrails.health.ts"
NEST_VALIDATION_REL = "src/ai-guardrails/ai_guardrails.validation.ts"
NEST_INDEX_REL = "src/ai-guardrails/index.ts"
NEST_CONFIGURATION_REL = "src/ai-guardrails/configuration.ts"
VENDOR_RELATIVE = "src/ai/ai_guardrails.py"
VENDOR_TYPES_RELATIVE = "src/ai/ai_guardrails_types.py"
