#!/usr/bin/env python3
"""Unified module generator for Ai Guardrails."""
...
from modules.free.ai.ai_guardrails.frameworks import get_plugin, list_available_plugins
...
MODULE_CLASS = "AiGuardrails"
MODULE_TITLE = "Ai Guardrails"
MODULE_TIER = "free"
MODULE_SLUG = "free/ai/ai_guardrails"
PYTHON_OUTPUT_REL = "src/modules/free/ai/ai_guardrails/ai_guardrails.py"
PYTHON_TYPES_REL = "src/modules/free/ai/ai_guardrails/ai_guardrails_types.py"
PYTHON_HEALTH_REL = "src/health/ai/ai_guardrails.py"
NEST_OUTPUT_REL = "src/modules/free/ai/ai_guardrails/ai_guardrails.service.ts"
NEST_CONTROLLER_REL = "src/modules/free/ai/ai_guardrails/ai_guardrails.controller.ts"
NEST_MODULE_REL = "src/modules/free/ai/ai_guardrails/ai_guardrails.module.ts"
NEST_HEALTH_REL = "src/health/ai_guardrails.health.ts"
NEST_VALIDATION_REL = "src/modules/free/ai/ai_guardrails/ai_guardrails.validation.ts"
NEST_INDEX_REL = "src/modules/free/ai/ai_guardrails/index.ts"
NEST_CONFIGURATION_REL = "src/modules/free/ai/ai_guardrails/configuration.ts"
VENDOR_RELATIVE = "src/modules/free/ai/ai_guardrails/ai_guardrails.py"
VENDOR_TYPES_RELATIVE = "src/modules/free/ai/ai_guardrails/ai_guardrails_types.py"
VENDOR_HEALTH_RELATIVE = "src/health/ai/ai_guardrails.py"
MODULE_IMPORT_PATH = "modules.free.ai.ai_guardrails"
...
class AiGuardrailsModuleGenerator(BaseModuleGenerator):
...
def _create_generator() -> AiGuardrailsModuleGenerator:
    return AiGuardrailsModuleGenerator()
