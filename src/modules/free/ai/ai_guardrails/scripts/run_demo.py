#!/usr/bin/env python3
"""Generate a small demo project for Ai Guardrails.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/ai_guardrails-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / f"ai_guardrails-{args.variant}"
