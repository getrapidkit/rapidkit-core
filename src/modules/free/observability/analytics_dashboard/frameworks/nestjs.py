"""NestJS plugin for Analytics Dashboard module scaffolding."""
...
class NestJSPlugin(FrameworkPlugin):
    ...
    def get_template_mappings(self) -> Dict[str, str]:
        return {
            "service": "templates/variants/nestjs/analytics_dashboard.service.ts.j2",
            "controller": "templates/variants/nestjs/analytics_dashboard.controller.ts.j2",
            "module": "templates/variants/nestjs/analytics_dashboard.module.ts.j2",
            "health": "templates/variants/nestjs/analytics_dashboard.health.ts.j2",
            "validation": "templates/variants/nestjs/analytics_dashboard.validation.ts.j2",
            "index": "templates/variants/nestjs/analytics_dashboard.index.ts.j2",
            "configuration": "templates/variants/nestjs/analytics_dashboard.configuration.ts.j2",
            "e2e": "templates/variants/nestjs/tests/analytics_dashboard.e2e-spec.ts",
        }
