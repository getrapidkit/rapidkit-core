#!/usr/bin/env python3
"""Generate a small demo project for Analytics Dashboard.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/analytics_dashboard-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / f"analytics_dashboard-{args.variant}"
