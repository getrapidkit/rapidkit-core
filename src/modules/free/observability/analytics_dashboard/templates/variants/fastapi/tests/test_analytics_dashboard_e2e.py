"""E2E smoke test for Analytics Dashboard (FastAPI).
...
def test_router_builds_without_crashing() -> None:
    ...
    router_rel = "src/modules/free/observability/analytics_dashboard/routers/observability/analytics_dashboard.py"
