#!/usr/bin/env python3
"""Unified module generator for Analytics Dashboard."""
...
from modules.free.observability.analytics_dashboard.frameworks import (
    get_plugin,
...
MODULE_CLASS = "AnalyticsDashboard"
...
class AnalyticsDashboardModuleGenerator(BaseModuleGenerator):
    ...
    def build_base_context(self, config: Mapping[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "module_kebab": "analytics-dashboard",
...
def _create_generator() -> AnalyticsDashboardModuleGenerator:
    return AnalyticsDashboardModuleGenerator()
