#!/usr/bin/env python3
"""Generate a small demo project for Webhook Platform.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/webhook_platform-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / f"webhook_platform-{args.variant}"
