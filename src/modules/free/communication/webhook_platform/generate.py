#!/usr/bin/env python3
"""Unified module generator for Webhook Platform."""
...
from modules.free.communication.webhook_platform.frameworks import (
    get_plugin,
...
MODULE_NAME = "webhook_platform"
MODULE_CLASS = "WebhookPlatform"
MODULE_TITLE = "Webhook Platform"
MODULE_TIER = "free"
MODULE_SLUG = "free/communication/webhook_platform"
PYTHON_OUTPUT_REL = "src/modules/free/communication/webhook_platform/webhook_platform.py"
PYTHON_TYPES_REL = "src/modules/free/communication/webhook_platform/webhook_platform_types.py"
PYTHON_HEALTH_REL = "src/health/communication/webhook_platform.py"
NEST_OUTPUT_REL = "src/modules/free/communication/webhook_platform/webhook_platform.service.ts"
NEST_CONTROLLER_REL = (
    "src/modules/free/communication/webhook_platform/webhook_platform.controller.ts"
)
NEST_MODULE_REL = "src/modules/free/communication/webhook_platform/webhook_platform.module.ts"
NEST_HEALTH_REL = "src/health/webhook_platform.health.ts"
NEST_VALIDATION_REL = (
    "src/modules/free/communication/webhook_platform/webhook_platform.validation.ts"
)
NEST_INDEX_REL = "src/modules/free/communication/webhook_platform/index.ts"
NEST_CONFIGURATION_REL = "src/modules/free/communication/webhook_platform/configuration.ts"
VENDOR_RELATIVE = "src/modules/free/communication/webhook_platform/webhook_platform.py"
VENDOR_TYPES_RELATIVE = "src/modules/free/communication/webhook_platform/webhook_platform_types.py"
VENDOR_HEALTH_RELATIVE = "src/health/communication/webhook_platform.py"
MODULE_IMPORT_PATH = "modules.free.communication.webhook_platform"
...
class WebhookPlatformModuleGenerator(BaseModuleGenerator):
...
def _create_generator() -> WebhookPlatformModuleGenerator:
    return WebhookPlatformModuleGenerator()
