...
PYTHON_OUTPUT_REL = "src/communication/webhook_platform.py"
PYTHON_TYPES_REL = "src/communication/webhook_platform_types.py"
PYTHON_HEALTH_REL = "src/health/communication/webhook_platform.py"
NEST_OUTPUT_REL = "src/webhook-platform/webhook_platform.service.ts"
NEST_CONTROLLER_REL = "src/webhook-platform/webhook_platform.controller.ts"
NEST_MODULE_REL = "src/webhook-platform/webhook_platform.module.ts"
NEST_HEALTH_REL = "src/webhook-platform/webhook_platform.health.ts"
NEST_VALIDATION_REL = "src/webhook-platform/webhook_platform.validation.ts"
NEST_INDEX_REL = "src/webhook-platform/index.ts"
NEST_CONFIGURATION_REL = "src/webhook-platform/configuration.ts"
VENDOR_RELATIVE = "src/communication/webhook_platform.py"
VENDOR_TYPES_RELATIVE = "src/communication/webhook_platform_types.py"
