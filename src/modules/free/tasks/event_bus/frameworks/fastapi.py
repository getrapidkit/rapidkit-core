"""FastAPI plugin for Event Bus module scaffolding."""
...
class FastAPIPlugin(FrameworkPlugin):
    ...
    def get_template_mappings(self) -> Dict[str, str]:
        return {
            "runtime": "templates/variants/fastapi/event_bus.py.j2",
            "router": "templates/variants/fastapi/event_bus_routes.py.j2",
            "health": "templates/variants/fastapi/event_bus_health.py.j2",
            "integration": "templates/tests/integration/test_event_bus_integration.j2",
            "e2e": "templates/variants/fastapi/tests/test_event_bus_e2e.py",
        }
