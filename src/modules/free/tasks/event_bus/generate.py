...
PYTHON_OUTPUT_REL = "src/tasks/event_bus.py"
PYTHON_TYPES_REL = "src/tasks/event_bus_types.py"
PYTHON_HEALTH_REL = "src/health/tasks/event_bus.py"
NEST_OUTPUT_REL = "src/event-bus/event_bus.service.ts"
NEST_CONTROLLER_REL = "src/event-bus/event_bus.controller.ts"
NEST_MODULE_REL = "src/event-bus/event_bus.module.ts"
NEST_HEALTH_REL = "src/event-bus/event_bus.health.ts"
NEST_VALIDATION_REL = "src/event-bus/event_bus.validation.ts"
NEST_INDEX_REL = "src/event-bus/index.ts"
NEST_CONFIGURATION_REL = "src/event-bus/configuration.ts"
VENDOR_RELATIVE = "src/tasks/event_bus.py"
VENDOR_TYPES_RELATIVE = "src/tasks/event_bus_types.py"
