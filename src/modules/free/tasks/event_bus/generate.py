#!/usr/bin/env python3
"""Unified module generator for Event Bus."""
...
from modules.free.tasks.event_bus.frameworks import get_plugin, list_available_plugins
...
MODULE_TITLE = "Event Bus"
MODULE_TIER = "free"
MODULE_SLUG = "free/tasks/event_bus"
PYTHON_OUTPUT_REL = "src/modules/free/tasks/event_bus/event_bus.py"
PYTHON_TYPES_REL = "src/modules/free/tasks/event_bus/event_bus_types.py"
PYTHON_HEALTH_REL = "src/health/tasks/event_bus.py"
NEST_OUTPUT_REL = "src/modules/free/tasks/event_bus/event_bus.service.ts"
NEST_CONTROLLER_REL = "src/modules/free/tasks/event_bus/event_bus.controller.ts"
NEST_MODULE_REL = "src/modules/free/tasks/event_bus/event_bus.module.ts"
NEST_HEALTH_REL = "src/health/event_bus.health.ts"
NEST_VALIDATION_REL = "src/modules/free/tasks/event_bus/event_bus.validation.ts"
NEST_INDEX_REL = "src/modules/free/tasks/event_bus/index.ts"
NEST_CONFIGURATION_REL = "src/modules/free/tasks/event_bus/configuration.ts"
VENDOR_RELATIVE = "src/modules/free/tasks/event_bus/event_bus.py"
VENDOR_TYPES_RELATIVE = "src/modules/free/tasks/event_bus/event_bus_types.py"
VENDOR_HEALTH_RELATIVE = "src/health/tasks/event_bus.py"
MODULE_IMPORT_PATH = "modules.free.tasks.event_bus"
...
class EventBusModuleGenerator(BaseModuleGenerator):
...
def _create_generator() -> EventBusModuleGenerator:
    return EventBusModuleGenerator()
