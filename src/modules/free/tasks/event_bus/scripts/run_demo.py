#!/usr/bin/env python3
"""Generate a small demo project for Event Bus.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/event_bus-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / f"event_bus-{args.variant}"
