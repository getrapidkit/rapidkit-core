...
PYTHON_OUTPUT_REL = "src/tasks/workflow_engine.py"
PYTHON_TYPES_REL = "src/tasks/workflow_engine_types.py"
PYTHON_HEALTH_REL = "src/health/tasks/workflow_engine.py"
NEST_OUTPUT_REL = "src/workflow-engine/workflow_engine.service.ts"
NEST_CONTROLLER_REL = "src/workflow-engine/workflow_engine.controller.ts"
NEST_MODULE_REL = "src/workflow-engine/workflow_engine.module.ts"
NEST_HEALTH_REL = "src/workflow-engine/workflow_engine.health.ts"
NEST_VALIDATION_REL = "src/workflow-engine/workflow_engine.validation.ts"
NEST_INDEX_REL = "src/workflow-engine/index.ts"
NEST_CONFIGURATION_REL = "src/workflow-engine/configuration.ts"
VENDOR_RELATIVE = "src/tasks/workflow_engine.py"
VENDOR_TYPES_RELATIVE = "src/tasks/workflow_engine_types.py"
