#!/usr/bin/env python3
"""Unified module generator for Workflow Engine."""
...
from modules.free.tasks.workflow_engine.frameworks import get_plugin, list_available_plugins
...
MODULE_TITLE = "Workflow Engine"
MODULE_TIER = "free"
MODULE_SLUG = "free/tasks/workflow_engine"
PYTHON_OUTPUT_REL = "src/modules/free/tasks/workflow_engine/workflow_engine.py"
PYTHON_TYPES_REL = "src/modules/free/tasks/workflow_engine/workflow_engine_types.py"
PYTHON_HEALTH_REL = "src/health/tasks/workflow_engine.py"
NEST_OUTPUT_REL = "src/modules/free/tasks/workflow_engine/workflow_engine.service.ts"
NEST_CONTROLLER_REL = "src/modules/free/tasks/workflow_engine/workflow_engine.controller.ts"
NEST_MODULE_REL = "src/modules/free/tasks/workflow_engine/workflow_engine.module.ts"
NEST_HEALTH_REL = "src/health/workflow_engine.health.ts"
NEST_VALIDATION_REL = "src/modules/free/tasks/workflow_engine/workflow_engine.validation.ts"
NEST_INDEX_REL = "src/modules/free/tasks/workflow_engine/index.ts"
NEST_CONFIGURATION_REL = "src/modules/free/tasks/workflow_engine/configuration.ts"
VENDOR_RELATIVE = "src/modules/free/tasks/workflow_engine/workflow_engine.py"
VENDOR_TYPES_RELATIVE = "src/modules/free/tasks/workflow_engine/workflow_engine_types.py"
VENDOR_HEALTH_RELATIVE = "src/health/tasks/workflow_engine.py"
MODULE_IMPORT_PATH = "modules.free.tasks.workflow_engine"
...
class WorkflowEngineModuleGenerator(BaseModuleGenerator):
...
def _create_generator() -> WorkflowEngineModuleGenerator:
    return WorkflowEngineModuleGenerator()
