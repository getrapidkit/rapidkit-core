#!/usr/bin/env python3
"""Generate a small demo project for Workflow Engine.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/workflow_engine-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / f"workflow_engine-{args.variant}"
