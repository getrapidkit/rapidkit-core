# Queue Platform Module Documentation

This directory contains the canonical documentation set for the queue platform module. Keep guidance
concise, actionable, and synchronised with the generator outputs.
