...
PYTHON_OUTPUT_REL = "src/tasks/queue_platform.py"
PYTHON_TYPES_REL = "src/tasks/queue_platform_types.py"
PYTHON_HEALTH_REL = "src/health/tasks/queue_platform.py"
NEST_OUTPUT_REL = "src/queue-platform/queue_platform.service.ts"
NEST_CONTROLLER_REL = "src/queue-platform/queue_platform.controller.ts"
NEST_MODULE_REL = "src/queue-platform/queue_platform.module.ts"
NEST_HEALTH_REL = "src/queue-platform/queue_platform.health.ts"
NEST_VALIDATION_REL = "src/queue-platform/queue_platform.validation.ts"
NEST_INDEX_REL = "src/queue-platform/index.ts"
NEST_CONFIGURATION_REL = "src/queue-platform/configuration.ts"
VENDOR_RELATIVE = "src/tasks/queue_platform.py"
VENDOR_TYPES_RELATIVE = "src/tasks/queue_platform_types.py"
