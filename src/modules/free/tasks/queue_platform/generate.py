#!/usr/bin/env python3
"""Unified module generator for Queue Platform."""
...
from modules.free.tasks.queue_platform.frameworks import get_plugin, list_available_plugins
...
MODULE_CLASS = "QueuePlatform"
MODULE_TITLE = "Queue Platform"
MODULE_TIER = "free"
MODULE_SLUG = "free/tasks/queue_platform"
PYTHON_OUTPUT_REL = "src/modules/free/tasks/queue_platform/queue_platform.py"
PYTHON_TYPES_REL = "src/modules/free/tasks/queue_platform/queue_platform_types.py"
PYTHON_HEALTH_REL = "src/health/tasks/queue_platform.py"
NEST_OUTPUT_REL = "src/modules/free/tasks/queue_platform/queue_platform.service.ts"
NEST_CONTROLLER_REL = "src/modules/free/tasks/queue_platform/queue_platform.controller.ts"
NEST_MODULE_REL = "src/modules/free/tasks/queue_platform/queue_platform.module.ts"
NEST_HEALTH_REL = "src/health/queue_platform.health.ts"
NEST_VALIDATION_REL = "src/modules/free/tasks/queue_platform/queue_platform.validation.ts"
NEST_INDEX_REL = "src/modules/free/tasks/queue_platform/index.ts"
NEST_CONFIGURATION_REL = "src/modules/free/tasks/queue_platform/configuration.ts"
VENDOR_RELATIVE = "src/modules/free/tasks/queue_platform/queue_platform.py"
VENDOR_TYPES_RELATIVE = "src/modules/free/tasks/queue_platform/queue_platform_types.py"
VENDOR_HEALTH_RELATIVE = "src/health/tasks/queue_platform.py"
MODULE_IMPORT_PATH = "modules.free.tasks.queue_platform"
...
class QueuePlatformModuleGenerator(BaseModuleGenerator):
...
def _create_generator() -> QueuePlatformModuleGenerator:
    return QueuePlatformModuleGenerator()
