...
PYTHON_OUTPUT_REL = "src/security/audit_policy.py"
PYTHON_TYPES_REL = "src/security/audit_policy_types.py"
PYTHON_HEALTH_REL = "src/health/security/audit_policy.py"
NEST_OUTPUT_REL = "src/audit-policy/audit_policy.service.ts"
NEST_CONTROLLER_REL = "src/audit-policy/audit_policy.controller.ts"
NEST_MODULE_REL = "src/audit-policy/audit_policy.module.ts"
NEST_HEALTH_REL = "src/audit-policy/audit_policy.health.ts"
NEST_VALIDATION_REL = "src/audit-policy/audit_policy.validation.ts"
NEST_INDEX_REL = "src/audit-policy/index.ts"
NEST_CONFIGURATION_REL = "src/audit-policy/configuration.ts"
VENDOR_RELATIVE = "src/security/audit_policy.py"
VENDOR_TYPES_RELATIVE = "src/security/audit_policy_types.py"
