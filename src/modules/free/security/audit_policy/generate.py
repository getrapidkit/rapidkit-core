#!/usr/bin/env python3
"""Unified module generator for Audit Policy."""
...
from modules.free.security.audit_policy.frameworks import get_plugin, list_available_plugins
...
MODULE_NAME = "audit_policy"
MODULE_CLASS = "AuditPolicy"
MODULE_TITLE = "Audit Policy"
MODULE_TIER = "free"
MODULE_SLUG = "free/security/audit_policy"
PYTHON_OUTPUT_REL = "src/modules/free/security/audit_policy/audit_policy.py"
PYTHON_TYPES_REL = "src/modules/free/security/audit_policy/audit_policy_types.py"
PYTHON_HEALTH_REL = "src/health/security/audit_policy.py"
NEST_OUTPUT_REL = "src/modules/free/security/audit_policy/audit_policy.service.ts"
NEST_CONTROLLER_REL = "src/modules/free/security/audit_policy/audit_policy.controller.ts"
NEST_MODULE_REL = "src/modules/free/security/audit_policy/audit_policy.module.ts"
NEST_HEALTH_REL = "src/health/audit_policy.health.ts"
NEST_VALIDATION_REL = "src/modules/free/security/audit_policy/audit_policy.validation.ts"
NEST_INDEX_REL = "src/modules/free/security/audit_policy/index.ts"
NEST_CONFIGURATION_REL = "src/modules/free/security/audit_policy/configuration.ts"
VENDOR_RELATIVE = "src/modules/free/security/audit_policy/audit_policy.py"
VENDOR_TYPES_RELATIVE = "src/modules/free/security/audit_policy/audit_policy_types.py"
VENDOR_HEALTH_RELATIVE = "src/health/security/audit_policy.py"
MODULE_IMPORT_PATH = "modules.free.security.audit_policy"
...
class AuditPolicyModuleGenerator(BaseModuleGenerator):
...
def _create_generator() -> AuditPolicyModuleGenerator:
    return AuditPolicyModuleGenerator()
