#!/usr/bin/env python3
"""Generate a small demo project for Audit Policy.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/audit_policy-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / f"audit_policy-{args.variant}"
