"""FastAPI framework plugin for the Db Sqlite module."""
...
class FastAPIPlugin(FrameworkPlugin):
    """Plugin exposing FastAPI-specific integrations for Db Sqlite."""
    ...
    def get_template_mappings(self) -> Dict[str, str]:
        return {
            "runtime": "templates/variants/fastapi/db_sqlite.py.j2",
            "routes": "templates/variants/fastapi/db_sqlite_routes.py.j2",
            "config": "templates/variants/fastapi/db_sqlite_config.yaml.j2",
            "integration_tests": "templates/tests/integration/test_db_sqlite_integration.j2",
        }

    def get_output_paths(self) -> Dict[str, str]:
        return {
            "runtime": "src/modules/free/database/db_sqlite/db_sqlite.py",
            "routes": "src/modules/free/database/db_sqlite/routers/db_sqlite.py",
            "config": "config/database/db_sqlite.yaml",
            "integration_tests": "tests/modules/integration/database/test_db_sqlite_integration.py",
        }
    ...
    def validate_requirements(self) -> list[str]:  # noqa: D401
        """FastAPI requires Starlette and FastAPI packages."""
