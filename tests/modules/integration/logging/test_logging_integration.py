...
from runtime.core.logging_health import register_logging_health  # type: ignore[import]
...
def test_imports():
    ...
    logging_module = importlib.import_module("runtime.core.logging")
    expected_symbols = [
        "get_logger",
        "LoggingConfig",
        "JsonFormatter",
...
def test_get_logger_basic():
    ...
    from runtime.core.logging import get_logger
...
def test_logging_config():
    ...
    from runtime.core.logging import LoggingConfig
...
def test_json_formatter():
    ...
    from runtime.core.logging import JsonFormatter
...
def test_colored_formatter():
    ...
    from runtime.core.logging import ColoredFormatter
...
def test_noise_filter():
    ...
    from runtime.core.logging import NoiseFilter

    noise_filter = NoiseFilter()

    logger = logging.getLogger("test")
    record = logger.makeRecord("test", logging.INFO, __file__, 1, "normal message", (), None)
...
def test_redaction_filter():
    ...
    from runtime.core.logging import RedactionFilter
...
def test_context_enricher():
    ...
    from runtime.core.logging import ContextEnricher
...
def test_create_stream_handler():
    ...
    from runtime.core.logging import create_stream_handler
...
def test_create_file_handler():
    ...
    from runtime.core.logging import create_file_handler
...
def test_module_exports():
    ...
    from runtime.core import logging as logging_module
...
def test_get_logging_metadata():
    ...
    from runtime.core.logging import get_logging_metadata
...
def test_request_context_middleware():
    ...
    try:
        ...
        from runtime.core.logging import RequestContextMiddleware
