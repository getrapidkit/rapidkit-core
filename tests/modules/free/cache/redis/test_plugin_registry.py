"""Tests for the Redis framework plugin registry."""

from importlib import import_module

import pytest

frameworks_module = import_module("modules.free.cache.redis.frameworks")
...
fastapi_plugins = import_module("modules.free.cache.redis.frameworks.fastapi")
nestjs_plugins = import_module("modules.free.cache.redis.frameworks.nestjs")
...
class TestRedisPluginRegistry:
    """Validate Redis registry exposes alias plugins."""
...
__all__ = ["TestRedisPluginRegistry"]
