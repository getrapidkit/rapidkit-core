"""Shared pytest fixtures for Db Postgres module tests."""
...
MODULE_IMPORT_PATH = "modules.free.database.db_postgres"
...
@pytest.fixture(scope="session")
def db_postgres_generator(module_generate: ModuleType):
    return module_generate.DbPostgresModuleGenerator()
