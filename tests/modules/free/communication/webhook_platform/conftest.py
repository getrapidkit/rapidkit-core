...
def module_test_context_fixture(tmp_path: Path) -> dict[str, object]:
    """Provide an isolated workspace for Webhook Platform module tests."""

    working_dir = tmp_path / "webhook_platform"
...
@pytest.fixture()
def rendered_webhook_platform(tmp_path: Path) -> dict[str, object]:
