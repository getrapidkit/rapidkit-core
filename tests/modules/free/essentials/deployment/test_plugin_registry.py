"""Tests for the deployment framework plugin registry."""

from importlib import import_module

import pytest

frameworks_module = import_module("modules.free.essentials.deployment.frameworks")
...
fastapi_plugins = import_module("modules.free.essentials.deployment.frameworks.fastapi")
nestjs_plugins = import_module("modules.free.essentials.deployment.frameworks.nestjs")
...
class TestDeploymentPluginRegistry:
    """Validate registry helpers enumerate alias plugins."""
...
__all__ = ["TestDeploymentPluginRegistry"]
