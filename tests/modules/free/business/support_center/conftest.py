...
def module_test_context_fixture(tmp_path: Path) -> dict[str, object]:
    """Provide an isolated workspace for Support Center module tests."""

    working_dir = tmp_path / "support_center"
...
@pytest.fixture()
def rendered_support_center(tmp_path: Path) -> dict[str, object]:
