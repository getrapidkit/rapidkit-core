...
def test_admin_console_fastapi_plugin_contract(tmp_path: Path) -> None:
    ...
    assert plugin.get_output_paths()["router"] == "src/routers/business/admin_console.py"
...
def test_admin_console_nestjs_plugin_contract(tmp_path: Path) -> None:
    ...
    assert plugin.get_output_paths()["module"] == "src/admin-console/admin_console.module.ts"
...
def test_admin_console_generate_wrappers_emit_expected_files(tmp_path: Path) -> None:
    ...
    assert (tmp_path / "src" / "business" / "admin_console.py").exists()
    assert (tmp_path / "src" / "routers" / "business" / "admin_console.py").exists()
    assert (tmp_path / "src" / "admin-console" / "admin_console.service.ts").exists()
