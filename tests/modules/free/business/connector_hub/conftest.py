...
def module_test_context_fixture(tmp_path: Path) -> dict[str, object]:
    """Provide an isolated workspace for Connector Hub module tests."""

    working_dir = tmp_path / "connector_hub"
...
@pytest.fixture()
def rendered_connector_hub(tmp_path: Path) -> dict[str, object]:
