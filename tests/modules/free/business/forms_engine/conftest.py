...
def module_test_context_fixture(tmp_path: Path) -> dict[str, object]:
    working_dir = tmp_path / "forms_engine"
...
@pytest.fixture()
def rendered_forms_engine(tmp_path: Path) -> dict[str, object]:
    ...
    return {"root": tmp_path, "vendor": _load_module("generated_forms_engine_vendor", vendor_path)}
