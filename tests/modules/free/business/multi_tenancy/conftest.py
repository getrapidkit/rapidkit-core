...
def module_test_context_fixture(tmp_path: Path) -> dict[str, object]:
    """Provide an isolated workspace for Multi Tenancy module tests."""

    working_dir = tmp_path / "multi_tenancy"
...
@pytest.fixture()
def rendered_multi_tenancy(tmp_path: Path) -> dict[str, object]:
