...
from modules.free.ai.llm_gateway import generate
...
def test_llm_gateway_version_consistency_no_bump(tmp_path: Path) -> None:
    module_root = Path(generate.__file__).resolve().parent
    isolated_root = _clone_module_root(module_root, tmp_path / "llm-gateway-module")
