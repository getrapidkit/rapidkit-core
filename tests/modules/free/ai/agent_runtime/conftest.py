...
def module_test_context_fixture(tmp_path: Path) -> dict[str, object]:
    """Provide an isolated workspace for Agent Runtime module tests."""

    working_dir = tmp_path / "agent_runtime"
...
@pytest.fixture()
def rendered_agent_runtime(tmp_path: Path) -> dict[str, object]:
