# ruff: noqa: I001
"""Integration tests for the PostgreSQL database module."""
...
def test_imports():
    ...
    module = import_module("runtime.core.database.postgres")
    expected_symbols = {
        "Base",
        "get_postgres_db",
        "get_sync_db",
...
def test_engine_configuration():
    ...
    from core.database.postgres import async_engine, sync_engine
...
def test_session_makers():
    ...
    from core.database.postgres import AsyncSessionLocal, SyncSessionLocal
...
def test_dependency_injection_signature():
    ...
    from core.database.postgres import get_postgres_db, get_sync_db
...
def test_context_managers_signature():
    ...
    from core.database.postgres import transactional_async, transactional_sync
...
def test_utility_functions():
    ...
    from core.database.postgres import get_database_url
...
def test_settings_integration():
    ...
    settings_module = import_module("core.settings")
...
def test_logging_integration():
    ...
    from core.database.postgres import logger
...
async def test_async_session_context():
    ...
    from core.database.postgres import get_postgres_db
...
def test_sync_session_context():
    ...
    from core.database.postgres import get_sync_db
...
def test_fastapi_health_endpoint(monkeypatch):
    ...
    postgres_health = import_module("runtime.core.health.database.postgres")
    ...
    def _fake_database_url(_: bool) -> str:
        return "postgresql://masked"

    monkeypatch.setattr(postgres_health, "get_database_url", _fake_database_url)
